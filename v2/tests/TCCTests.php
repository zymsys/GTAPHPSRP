...
class TCCTests extends PHPUnit_Framework_TestCase {
	...
	public function test_wronganswer()
	{
		...
		$this->assertEquals(1, $calc->getPlays());
		$this->assertEquals(0, $calc->getFirstTries());
	}
	...
	public function test_correctanswer()
	{
		...
		$this->assertEquals(2, count($urlparts));
		...
		$this->assertEquals('1', $params['plays']);
		$this->assertEquals('1', $params['firsttries']);
	}
}